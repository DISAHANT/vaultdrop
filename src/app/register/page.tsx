  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-16 md:py-24 animate-fade-up">
      <div className="text-center mb-8">
        ...
        <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Get device sync, workspaces, and personal file bridge</p>
      </div>
      ...
      <p className="text-center text-sm mt-6" style={{ color: 'var(--text-secondary)' }}>
        Already have an account? <Link href="/login" className="font-semibold underline text-[var(--accent)] hover:opacity-80">Sign in</Link>
      </p>
    </div>
  );
}
